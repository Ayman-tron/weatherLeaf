...
final locationRepositoryFutureProvider =
    AutoDisposeFutureProvider<Location>.internal(
  locationRepositoryFuture,
  name: r'locationRepositoryFutureProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$locationRepositoryFutureHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef LocationRepositoryFutureRef = AutoDisposeFutureProviderRef<Location>;
